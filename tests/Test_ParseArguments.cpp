...
Test(parse_arguments, test_parse_arguments_valid)
{
    ...
    const bool result = raytracer::parser::parse_arguments(2, (char **) argv);
...
Test(parse_arguments, test_parse_arguments_version)
{
    ...
    const bool rv1 = raytracer::parser::parse_arguments(2, (char **) argv1);
    const bool rv2 = raytracer::parser::parse_arguments(2, (char **) argv2);
