...
class Error : public std::exception
{
  public:
    ...
    constexpr explicit Error(const std::string& where, Args&&... args) : _where(where), _what(concatStrings(std::forward<Args>(args)...))
    {
        /* empty */
    }
  ...
  private:
     ...
     * @return std::string
     */
    template <typename... Args> static std::string concatStrings(Args&&... args)
    {
